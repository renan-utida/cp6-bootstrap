...
function Destaques(){
    ...
    return(
        <section className="row mt-5 mw-100 text-center">
            ...
            <div className="col-6 my-4">
                <div className='m-2 p-2 bg-secondary text-white border border-primary border-3 rounded-4'>
                    ...
                    <Button variant="danger" className='my-3'>Clique aqui!</Button>{' '}
                </div>
            </div>
            <div className="col-6 mt-2 mb-4">
                <div className='m-2 p-2 bg-secondary text-white border border-primary border-3 rounded-4'>
                    ...
                    <Button variant="danger" className='my-3'>Últimas unidades!</Button>{' '}
                </div>
            </div>
            <div className="col-6 mt-2 mb-4">
                <div className='m-2 p-2 bg-secondary-subtle text-black border border-primary border-3 rounded-4'>
